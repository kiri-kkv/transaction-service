...
public class TransactionController {
    ...
    ResponseEntity<ApiResponse<Object>> addTransactions(@RequestBody TransactionDto transactionDto){
    ...
    ResponseEntity<ApiResponse<Page<Transactions>>> getTransactions(@RequestParam(value="page",required = false,defaultValue = "0") int page,
                                                                    ...
                                                                    @RequestBody FinanceOverviewDto financeOverviewDto
                                                   ) throws ParseException {
        return transactionService.getTransactions(page,size,financeOverviewDto);
    }

    @GetMapping("/finance-overview")
    ResponseEntity<ApiResponse<Object>> getFinanceOverview(@RequestBody FinanceOverviewDto financeOverviewDto) throws ParseException {
        return transactionService.getFinanceOverview(financeOverviewDto);
    }

    @GetMapping("/transactions-by-category")
    ResponseEntity<ApiResponse<Object>> getTransactionsByCategory(@RequestBody FinanceOverviewDto financeOverviewDto) throws ParseException {
